...
with app.app_context():
    ...
    if not Category.query.first():
        ...
        veg_pizza = Category( # type: ignore
            name="Veg Pizza",
            slug="veg-pizza",
    ...
    if not AboutContent.query.first():
        ...
        about_hero = AboutContent( # type: ignore
            section='hero',
